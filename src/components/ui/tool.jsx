          ...
          <div className="bg-background space-y-3 p-3">
            ...
            {output && (
              <div>
                ...
                <div
                  className="bg-background max-h-60 overflow-auto rounded border p-2 font-mono text-sm">
            ...
            {state === "output-error" && toolPart.errorText && (
              <div>
                ...
                <div
                  className="bg-background rounded border border-red-200 p-2 text-sm dark:border-red-950 dark:bg-red-900/20">
                  {toolPart.errorText}
                </div>
              </div>
            )}
